  ...
  return (
    <nav className="w-full">
      ...
      <div className="bg-white relative">
        <div className="container mx-auto text-black flex md:flex-none items-center px-4">
...
const TopBar = ({ phone, links, socials }: TopBarProps) => (
  <small className="border-b bg-secondary text-white py-2 w-full flex items-center justify-between gap-5">
    <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-2 text-sm font-medium">
